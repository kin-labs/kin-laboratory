...
export class Keypair {
   ...
   * @returns {Keypair}
   */
  static fromSecretKeypair(secret: string) {
    const rawSecret = StrKey.decodeEd25519SecretSeed(secret);
    return this.fromRawEd25519Seed(rawSecret);
  }

  static fromSecret(secret: string): SimpleKeypair {
    const rawSecret = StrKey.decodeEd25519SecretSeed(secret);
   ...
   * @returns {Keypair}
   */
  static fromRawEd25519Seed(rawSeed: any): Keypair {
   ...
   * @returns {Keypair}
   */
  static fromPublicKey(publicKey: any) {
